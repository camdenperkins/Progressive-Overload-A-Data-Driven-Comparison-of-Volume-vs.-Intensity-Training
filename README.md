...
### Confusion Matrix
<img width="783" height="260" alt="image" src="https://github.com/user-attachments/assets/3e17f513-c438-4419-825f-b67f15bc7f0f" />
...
Average weekly % change in weight: 0.65% <br>
Average weekly % change in reps: 1.65%

<img width="484" height="112" alt="image" src="https://github.com/user-attachments/assets/b37f6f5f-23c0-4dd5-ad1a-af335f269572" /> <br><br>
...
### Visualization #1
<img width="596" height="433" alt="image" src="https://github.com/user-attachments/assets/73aa350d-92d4-494c-aa16-547ac89c4421" /> <br>
### Analysis
...
### Visualization #2
<img width="749" height="434" alt="image" src="https://github.com/user-attachments/assets/dc59aa0c-de84-4366-9330-55a30c019198" /> <br>
### Analysis
...
This bar chart shows that the simulation slightly outperformed both exercises from my summer training data in terms of total overload events. At first glance, this suggests the model was more effective at driving progression. However, it's important to factor in context: each non-simulated exercise was performed over just half the duration of the simulated block. This comparison also overlooks the initial adaptation period required when beginning a new machine or exercise, which can temporarily dampen overload rates. Therefore, it's reasonable to infer that if a single exercise had been trained continuously across the full 12-week span, the outcomes would likely lean even more favorably toward the real-world data. When adjusted for time, the simulation may have actually underperformed relative to real-world training—potentially due to a more consistent diet during the summer, improved rest, and access to equipment better suited for generating progressive overload.
